...
### Known issues
(Differences mentioned are from actual measurements of motors, making belts centered on gearheads' teeth, etc. Belts are in blend file in Poikilos' Voron Legacy folder on Google Drive, along with these fixes)
...
- Move A (right) gearhead (20T pulley) down by 2.35 so it is 3.45 less than end of motor shaft
- Move B (left) gearhead (20T pulley) up by 0.10217 so it sticks out 1.25mm more than end of motor shaft
